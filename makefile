main.exe		: 	main.o transform.o sprites.o fuzzylogic.o algorithm.o graphics.o 
	g++ -O2 -std=c++11  -Wl,-s -o main.exe main.o transform.o sprites.o fuzzylogic.o algorithm.o graphics.o -l gdi32 -static-libgcc -static-libstdc++
			
main.o		:	main.cpp graphics.h nodes.h transform.h sprites.h fuzzylogic.h algorithm.h
